...
def merge_window():
      ...
      layout = [
            ...
            [sg.Text('Укажите имя для файлов:', size=(35, 1), font='Roboto'), sg.InputText(size=(30, 1), font='Roboto')],
      ...
      while True:  
            ...
            WORD_path, Excel_path, Save_path, Doc_name = values[0], values[1], values[2], values[3]
            ...
            if event == 'Старт':
                  ...
                  if error_1 == '' and error_2 == '':
                        merge_docs(table_data, WORD_path, Save_path, Doc_name)
